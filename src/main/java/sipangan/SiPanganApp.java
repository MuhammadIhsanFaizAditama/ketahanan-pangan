...
public class SiPanganApp {
    ...
    private void showMainMenu() {
        ...
        System.out.println("2. Manajemen Produk Pangan");
        System.out.println("3. Manajemen Stok Gudang");
    ...
    private void showDashboard() {
        ...
        System.out.printf("Jumlah Entri Stok Kritis     : %d\n", stokKritis);
        System.out.println("-------------------------------------------------------");
    ...
    private void editProduk() {
        ...
        System.out.print(
                "Tgl Kedaluwarsa Baru (YYYY-MM-DD atau kosongkan untuk tidak mengubah, tulis 'null' untuk menghapus tgl): ");
        String tgl = scanner.nextLine().trim();
        if (!tgl.isEmpty()) {
    ...
    private void kurangiStok() {
        ...
        System.out.println("Stok saat ini: " + target.getKuantitas() + " unit (" + target.getProduk().getNamaProduk()
                + " di " + target.getGudangWilayah() + ")");
